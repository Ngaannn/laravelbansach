...
@section('meta_tags')
    ...
    <title>Thông tin liên hệ đại lý sơn Tàu biển</title>
    <meta name='description' itemprop='description' content='Thông tin liên hệ đại lý sơn Tàu biển. Mọi thắc mắc vui lòng tìm chúng tôi qua bản đồ hoặc gọi điện thoại hoặc đến trực tiếp văn phòng của chúng tôi.' />
    <link rel="canonical" href="{{url()->current()}}" />
    <meta property='article:published_time' content='' />
    <meta property='article:section' content='event' />
    <meta property="og:description" content="Thông tin liên hệ đại lý sơn Tàu biển. Mọi thắc mắc vui lòng tìm chúng tôi qua bản đồ hoặc gọi điện thoại hoặc đến trực tiếp văn phòng của chúng tôi." />
    <meta property="og:url" content="{{url()->current()}}" />
    <meta property="og:type" content="article" />
    <meta property="og:locale" content="en-us" />
    <meta property="og:locale:alternate" content="vi-vn" />
    <meta property="og:site_name" content="{{env('SITE_URL', 'Thông tin liên hệ đại lý sơn Tàu biển')}}" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="Thông tin liên hệ đại lý sơn Tàu biển" />
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="caption-contact">
                                        ...
                                        <div class="caption-contact-body">
                                            ...
                                            <p><i class="fa fa-home"></i> Website: www.dailysontaubien.com </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
