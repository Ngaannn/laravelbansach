...
@section('meta_tags')
    ...
    <meta name='description' itemprop='description' content='Sản phẩm khuyến mãi' />
    <meta property='article:published_time' content='' />
    <link rel="canonical" href="{{url()->current()}}" />
    <meta property='article:section' content='event' />
    <meta property="og:description" content="Sản phẩm khuyến mãi" />
    <meta property="og:title" content="Sản phẩm khuyến mãi" />
    <meta property="og:url" content="{{url()->current()}}" />
    <meta property="og:type" content="article" />
    <meta property="og:locale" content="en-us" />
    <meta property="og:locale:alternate" content="vi-vn" />
    <meta property="og:site_name" content="{{env('SITE_URL', 'Sản phẩm khuyến mãi')}}" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:title" content="Sản phẩm khuyến mãi" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumb list-unstyled">
                        ...
                        <li>
                            <a itemprop="title">Sản phẩm khuyến mãi</span></a>
                        </li>
                    </ul>
                </div>
            </div>
